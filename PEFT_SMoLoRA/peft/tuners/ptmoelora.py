...
@dataclass
class PTMOELoraConfig(LoraConfig):
    """
...
class PTMOELoraModel(LoraModel):
    """
    ...
    def _create_new_module(self, lora_config, adapter_name, target):
        ...
        if loaded_in_8bit and isinstance(target, bnb.nn.Linear8bitLt):
            ...
            new_module = PTMOELoraLinear(adapter_name, in_features, out_features, 
                                                    bias=bias, **kwargs)
...
class PTMOELoraLayer(LoraLayer):
    ...
    def update_layer(self, adapter_name, r, lora_alpha, lora_dropout, init_lora_weights):
        ...
        if r > 0:
            self.lora_A.update(nn.ModuleDict({adapter_name: PTMOELinearA(self.in_features, r, self.expert_num)}))
            self.lora_B.update(nn.ModuleDict({adapter_name: PTMOELinearB(r, self.out_features, self.expert_num)}))
...
class PTMOELoraLinear(nn.Linear, PTMOELoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        PTMOELoraLayer.__init__(self, in_features=in_features, 
...
class PTMOELinearA(nn.Module):
    ...
    def __init__(self, in_features, out_features, expert_num) -> None:
        ...
        for _ in range(self.expert_num):
            self.loraA.append(PTMOEExpert(self.in_features, self.r))
...
class PTMOELinearB(nn.Module):
    ...
    def __init__(self, in_features, out_features, expert_num) -> None:
        ...
        for _ in range(self.expert_num):
            self.loraB.append(PTMOEExpert(self.r, self.out_features))
...
class PTMOERouter(nn.Module):
    ...
    def __init__(self, config: PTMOELoraConfig):
        super().__init__()
