...
RESULT_DIR="./results/SMoLoRA/TextCaps_single"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.SMoLoRA.MET.model_caption \
        ...
        --ins-type 2 \
        --question-file /data/zqwang/moe_cl_data/CVIT_benchmark/Instructions_Single/TextCaps/val.json \
...
python llava/eval/SMoLoRA/Eval/eval_textcaps_cider.py \
