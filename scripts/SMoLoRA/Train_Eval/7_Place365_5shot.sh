...
deepspeed --include localhost:4,5,6,7 --master_port 29600 llava/train/train_mem_SMoLoRA.py \
    ...
    --data_path /data/zqwang/moe_cl_data/CVIT_benchmark/Instructions_Single/Places365/train_5shot.json \
    ...
    --bf16 True \
    --output_dir /data/zqwang/moe_cl_data/checkpoint/SMoLoRA/Instruction_single_type/Place365_5shot/llava-1.5-7b-lora \
    --num_train_epochs 1 \
